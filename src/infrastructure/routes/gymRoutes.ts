...
router.put('/edit_gym_profile',(protect),(req,res)=>gymController.editGymProfile(req,res))
router.patch('/edit_gym_images',protect,ImageUpload.array('images', 4),(req,res)=>gymController.editGymImages(req,res))
